...
export function buildFirstPlanPrompt(profile: ClientProfile, rules: string): FirstPlanPrompt {
  return {
    system: [
      ...
      'day_index is an ISO weekday: 1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday,',
      '5 = Friday, 6 = Saturday, 7 = Sunday. The day whose day_index equals',
      'schedule_preferences.rest_day must have the type "rest".',
