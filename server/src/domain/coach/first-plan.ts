...
export function buildFirstPlanPrompt(profile: ClientProfile, rules: string): FirstPlanPrompt {
  return {
    system: [
      ...
      'Every weight in the profile and in your output is in pounds, and every height is in inches.',
      ...
      'Follow the coaching rules. This client has no training history: leave weight_lb null for',
