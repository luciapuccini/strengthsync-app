...
- Thread that note through weekly progression into the inline prompts in [`server/src/workflows/strengthsync-workflow.ts`](../../server/src/workflows/strengthsync-workflow.ts), alongside the frozen schedule.
